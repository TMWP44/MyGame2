class Game {
  ...
  play() {
   ...
   // if (allPlayers !== undefined) {
      image(track, width/2 - 175, -height * 5, 450, height * 6);
  ...
  handlePlayerControls() {
    if (!this.blast) {
      ...
      if (keyIsDown(LEFT_ARROW) && car.x > width / 3 - 50) {
        this.leftKeyActive = true;
        car.x -= 5;
       // player.update();
      }
  
      if (keyIsDown(RIGHT_ARROW) && car.x < width / 2 + 300) {
        this.leftKeyActive = false;
        car.x += 5;
       // player.update();
      }
